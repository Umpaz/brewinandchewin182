...
public class KegContainer extends AbstractContainerMenu
{
	...
	public KegContainer(final int windowId, final Inventory playerInventory, final KegBlockEntity tileEntity, ContainerData cookingPotDataIn) {
		...
		// Meal Display
		this.addSlot(new KegMealSlot(inventory, 4, 122, 23));

		// Bowl Input
		this.addSlot(new SlotItemHandler(inventory, 5, 90, 55)
		{
			@OnlyIn(Dist.CLIENT)
		...
		// Bowl Output
		this.addSlot(new KegResultSlot(playerInventory.player, tileEntity, inventory, 6, 122, 55));
